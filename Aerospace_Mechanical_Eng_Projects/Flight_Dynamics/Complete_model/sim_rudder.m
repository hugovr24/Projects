...
grid;
figure(1);
subplot(421);plot(tout,yout(:,out_ind(logical(strcmp('ACFT/Beta_deg',outr))))); xlabel('Time - [s]');ylabel('Beta - [deg]')
...
subplot(425);plot(tout,yout(:,out_ind(logical(strcmp('ACFT/p_degps',outr))))); xlabel('Time - [s]');ylabel('Roll Rate - [deg/s]')
subplot(426);plot(tout,yout(:,out_ind(logical(strcmp('ACFT/r_degps',outr))))); xlabel('Time - [s]');ylabel('Yaw Rate - [N]')
